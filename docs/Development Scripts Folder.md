...
If `Open Scripts Folder`, `ls -ld "/Library/Application Support/Sonic Charge/Microtonic Scripts"`,
or `readlink "/Library/Application Support/Sonic Charge/Microtonic Scripts"` shows the live folder is
